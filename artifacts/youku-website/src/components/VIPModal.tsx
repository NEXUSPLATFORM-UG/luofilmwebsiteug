...
const DEFAULT_PLANS = [
  { id: "day1", label: "1 Day Pass", tag: "TRY IT", tagColor: "#888", price: 2500 },
  { id: "day3", label: "3 Days Pass", tag: "POPULAR", tagColor: "#f5a623", price: 5000 },
  { id: "week1", label: "1 Week Pass", tag: "GREAT VALUE", tagColor: "#e05a7a", price: 10000 },
  { id: "month1", label: "1 Month Pass", tag: "BEST DEAL", tagColor: "#059669", price: 20000 },
];
...
export default function VIPModal({ onClose }: VIPModalProps) {
  ...
  useEffect(() => {
    fbApi.settings.get().then((s: any) => {
      if (!s) return;
      setPlans([
        { id: "day1", label: "1 Day Pass", tag: "TRY IT", tagColor: "#888", price: Number(s.plan1DayPrice ?? 2500) },
        { id: "day3", label: "3 Days Pass", tag: "POPULAR", tagColor: "#f5a623", price: Number(s.plan3DaysPrice ?? 5000) },
        { id: "week1", label: "1 Week Pass", tag: "GREAT VALUE", tagColor: "#e05a7a", price: Number(s.plan1WeekPrice ?? 10000) },
        { id: "month1", label: "1 Month Pass", tag: "BEST DEAL", tagColor: "#059669", price: Number(s.plan1MonthPrice ?? 20000) },
      ]);
    }).catch(() => {});
  }, []);
      ...
      <div style={{ position: "relative", width: 820, maxWidth: "95vw", maxHeight: "90vh", overflowY: "auto", borderRadius: 16, background: "#fff", display: "flex", boxShadow: "0 20px 60px rgba(0,0,0,0.5)", color: "#1a1a1a" }}>
        ...
        <div style={{ flex: 1, padding: "24px 24px 28px", minWidth: 0, borderRight: "1px solid #f0f0f0" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 20, paddingLeft: 4 }}>
            ...
            <button style={{ fontSize: 15, fontWeight: 600, color: "#1a1a1a", background: "transparent", border: "none", cursor: "pointer", display: "flex", alignItems: "center", gap: 4 }}>
              Log in / Sign up <span style={{ fontSize: 13, color: "#999" }}>&gt;</span>
            </button>
          </div>
