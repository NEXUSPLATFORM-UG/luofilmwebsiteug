...
export default function AuthModal({ onClose, onAuth }: AuthModalProps) {
  ...
  function handleLogin(e: React.FormEvent) {
    ...
    setTimeout(() => {
      setLoading(false);
      onAuth({ name: "User", phone: loginPhone, email: "" });
      onClose();
    }, 800);
  }
  ...
  function handleRegister(e: React.FormEvent) {
    ...
    setTimeout(() => {
      setLoading(false);
      onAuth({ name: `${firstName} ${lastName}`, phone: regPhone, email: regEmail });
      onClose();
    }, 800);
  }
  ...
  function handleGoogleLogin() {
    ...
    setTimeout(() => {
      ...
      if (tab === "register") {
        ...
        onAuth({ name: "Google User", phone: "", email: "user@gmail.com", avatar: "https://img.alicdn.com/imgextra/i2/O1CN01lr1KAH1eIQrB1u9ZK_!!6000000003848-2-tps-138-138.png" });
        onClose();
      }
    }, 800);
  }
  ...
  function handleGooglePhoneSubmit(e: React.FormEvent) {
    ...
    setTimeout(() => {
      setLoading(false);
      if (googleUser) {
        onAuth({ name: googleUser.name, phone: googlePhone, email: googleUser.email, avatar: "https://img.alicdn.com/imgextra/i2/O1CN01lr1KAH1eIQrB1u9ZK_!!6000000003848-2-tps-138-138.png" });
      }
      onClose();
    }, 700);
  }
    ...
    >
      ...
      >
        <style>{`
          ...
          .auth-input:focus {
            border-color: rgba(0,169,245,0.6) !important;
          }
        ...
        >
          {step === "google-phone" ? (
            <div>
              <div style={{ fontSize: 16, fontWeight: 700, color: "#fff" }}>One more step</div>
        ...
        <div style={{ padding: "20px 20px 24px" }}>
              ...
              >
                <div
                  style={{
                    ...
                    height: 38,
                    borderRadius: "50%",
                    background: "linear-gradient(135deg,#00a9f5,#0076d6)",
                    display: "flex",
                    alignItems: "center",
                    justifyContent: "center",
                    fontSize: 16,
            ...
            <form onSubmit={handleLogin} style={{ display: "flex", flexDirection: "column", gap: 14 }}>
              ...
              <p style={{ textAlign: "center", fontSize: 12, color: "rgba(255,255,255,0.3)", margin: 0 }}>
                ...
                <button
                  ...
                  style={{ background: "none", border: "none", color: "#00a9f5", cursor: "pointer", fontSize: 12, padding: 0 }}
                >
                  Register now
                </button>
              </p>
          ...
          {step === "main" && tab === "register" && (
            <form onSubmit={handleRegister} style={{ display: "flex", flexDirection: "column", gap: 12 }}>
              ...
              <button type="submit" style={{ ...primaryBtn, marginTop: 2 }} disabled={loading}>
