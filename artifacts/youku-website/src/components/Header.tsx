        ...
        <div style={{ display: "flex", alignItems: "center", gap: 4 }}>
          ...
          >
            ...
            {searchValue && (
              <button onClick={() => setSearchValue("")}
                style={{ color: "rgba(255,255,255,0.3)", lineHeight: 1, cursor: "pointer", background: "none", border: "none", flexShrink: 0, padding: 0 }}>
          ...
          <button
            ...
            style={{
              ...
              color: "#3d2200", fontSize: 13, fontWeight: 700, border: "none", cursor: "pointer", flexShrink: 0,
              boxShadow: "0 2px 8px rgba(245,200,66,0.35)", transition: "filter 0.2s, box-shadow 0.2s", letterSpacing: "0.02em",
            }}
            onMouseEnter={(e) => {
              (e.currentTarget as HTMLElement).style.filter = "brightness(1.08)";
              (e.currentTarget as HTMLElement).style.boxShadow = "0 3px 12px rgba(245,200,66,0.5)";
            }}
            onMouseLeave={(e) => {
              (e.currentTarget as HTMLElement).style.filter = "brightness(1)";
              (e.currentTarget as HTMLElement).style.boxShadow = "0 2px 8px rgba(245,200,66,0.35)";
            }}
          >
          ...
          {user && ADMIN_EMAILS.includes(user.email || "") && (
            <Link href="/admin">
              <div
                style={{
                  display: "flex", alignItems: "center", gap: 5, padding: "0 12px", height: 32, borderRadius: 6,
                  background: "rgba(99,102,241,0.15)", border: "1px solid rgba(99,102,241,0.4)",
                  color: "#818cf8", fontSize: 12, fontWeight: 600, cursor: "pointer", flexShrink: 0,
          ...
          {user ? (
            <div style={{ position: "relative", marginLeft: 4 }}>
              <button
                ...
                style={{
                  ...
                  padding: 0, flexShrink: 0, transition: "border-color 0.2s, box-shadow 0.2s",
              ...
              >
                <img
                  src={profile?.avatar || user.photoURL || `https://api.dicebear.com/9.x/lorelei/svg?seed=${user.uid}`}
                ...
                <>
                  ...
                  <div
                    style={{
                      ...
                      borderRadius: 10, width: 200, zIndex: 160, overflow: "hidden",
                      boxShadow: "0 12px 40px rgba(0,0,0,0.6)", animation: "slideDown 0.15s ease",
                    }}
                  >
                    ...
                    {[
                      ...
                      <button key={label}
                        style={{
                          ...
                          background: "transparent", border: "none", color: "rgba(255,255,255,0.65)", fontSize: 13,
                    ...
                    <button onClick={handleLogout}
                      style={{
                        width: "100%", padding: "10px 16px", display: "flex", alignItems: "center", gap: 10,
                        background: "transparent", border: "none", color: "#ff6b6b", fontSize: 13,
                        cursor: "pointer", textAlign: "left", transition: "background 0.15s",
                      }}
            ...
            <button
              ...
              style={{
                ...
                flexShrink: 0, letterSpacing: "0.08em", transition: "filter 0.2s, box-shadow 0.2s",
                marginLeft: 4, boxShadow: "0 2px 10px rgba(168,85,247,0.4)",
              }}
              onMouseEnter={(e) => {
